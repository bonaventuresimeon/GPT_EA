...
REQUIRED_FILES = [
    ...
    "docs/INTELLIGENCE_HARDENING_TESTS.md",
    "docs/FULL_INTELLIGENCE_COVERAGE.md",
    "docs/OPENAI_INTELLIGENCE_POLICY.md",
    "docs/STOP_MANAGEMENT_TEST_MATRIX.md",
    "docs/PARTIAL_PROTECTION_RELEASE_TEST.md",
    "docs/STOP_FAILURE_OBSERVABILITY.md",
    "docs/BROKER_STOP_RELEASE_EVIDENCE.md",
    "docs/RELEASE_CERTIFICATION.md",
    "docs/METAEDITOR_COMPILE_GATE.md",
    "docs/DEMO_SOAK_ACCEPTANCE.md",
    "docs/DEMO_SOAK_EVIDENCE.md",
    "docs/DEMO_SOAK_REPORT_TEMPLATE.md",
    "FIVE_DAY_SOAK_ACCEPTANCE_SCHEMA.json",
    "FIVE_DAY_SOAK_ACCEPTANCE_TEMPLATE.json",
    "docs/FIVE_DAY_SOAK_ACCEPTANCE_RECORD.md",
    "docs/FIVE_DAY_SOAK_OPERATOR_RECORD_TEMPLATE.md",
    "CI_EVIDENCE_SCHEMA.json",
    "CI_EVIDENCE_BUNDLE_SCHEMA.json",
    "docs/CI_EVIDENCE_CONTRACT.md",
    "SOAK_EVIDENCE_SCHEMA.json",
    "docs/DEPLOYMENT_DRIFT_TESTS.md",
    "docs/API_TRANSPORT_docs/ARCHITECTURE.md",
    "docs/API_TRANSPORT_TEST_MATRIX.md",
    "docs/MT5_WEBREQUEST_REQUIREMENTS.md",
    "docs/RELEASE_GO_NO_GO.md",
    "docs/RELEASE_EVIDENCE_MANIFEST.md",
    "docs/ADAPTIVE_EXECUTION_docs/ARCHITECTURE.md",
    "docs/ADAPTIVE_EXECUTION_TEST_MATRIX.md",
    "docs/R6_RESILIENCE_HARDENING_TEST_MATRIX.md",
    "RESILIENCE_HARDENING_EVIDENCE_SCHEMA.json",
    "RESILIENCE_HARDENING_EVIDENCE_TEMPLATE.json",
    "docs/ROLLBACK_PACKAGE_CONTRACT.md",
    "ROLLBACK_PACKAGE_MANIFEST_SCHEMA.json",
    "MT5_VALIDATION_EVIDENCE_SCHEMA.json",
    "MT5_VALIDATION_EVIDENCE_TEMPLATE.json",
    "docs/MT5_VALIDATION_ACCEPTANCE_MATRIX.md",
